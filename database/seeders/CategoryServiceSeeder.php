...
class CategoryServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('category_services')->insert([
            ['code' => 'ICS01', 'name' => 'Pagos', 'user_id' => 1, 'dependence' => '', 'ind_service' => true, 'sort' => 1, 'status' => true, 'created_at' => now() ], 
            ...
            ['code' => 'ICS04','name' => 'Aduana', 'user_id' => 1,'dependence' => '', 'ind_service' => true, 'sort' => 4,'status' => true,'created_at' => now() ], 
            ['code' => 'ICS05','name' => 'Tipos de cambio', 'user_id' => 1, 'dependence' => '2,3,4,5,6,7', 'ind_service' => true, 'sort' => 5,'status' => true,'created_at' => now() ],
