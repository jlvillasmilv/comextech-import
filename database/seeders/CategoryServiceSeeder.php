...
class CategoryServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('category_services')->insert([
            ...
            ['code' => 'ICS05','name' => 'Entrega', 'user_id' => 1, 'dependence' => '2,3,4,5,6,7', 'ind_service' => true, 'sort' => 5,'status' => true,'icon' => "noto-v1:letter-t" ],
            ['code' => 'ICS06','name' => 'Transporte Local', 'user_id' => 1,'dependence' => '', 'ind_service' => false, 'sort' => 6,'status' => true,'icon' => "noto-v1:letter-t" ],
            ['code' => 'ICS07','name' => 'Tipo de cambio', 'user_id' => 1,'dependence' => '', 'ind_service' => false, 'sort' => 7,'status' => false,'icon' => "noto-v1:letter-p" ], 
