...
class DHLTracking extends Model
{
    use HasFactory;
...
**********************/
	...
	function __construct($mode = 'live'){
		//
		$this->_PIurl     = "https://xmlpi-ea.dhl.com/XMLShippingServlet?isUTF8Support=true"; 
	...
	function single($airbill){
		...
		$this->_xml .= "</ServiceHeader>" . $this->_xmlEnd;
		$this->_xml .= "</Request>" . $this->_xmlEnd;
		$this->_xml .= "<LanguageCode>es</LanguageCode>". $this->_xmlEnd;
