...
$impuesto_sii = auth()
    ->user()
    ->FileStoreClient->where('type', 'impuesto_sii');
$carp_tributaria = auth()
    ->user()
    ->FileStoreClient->where('type', 'carp_tributaria');
            ...
            @if ($impuesto_sii->isEmpty() || $carp_tributaria->isEmpty())
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        No se ah ingresado información de su empresa. Recomendamos actualizar la información de su
                        empresa

                        <a href="{{ route('company.index') }}" class="text-sm text-blue-700 underline">(ingresa
                            aqui)</a>
                    ...
                    <table id="table" class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @forelse($applications->sortBy('status') as $application)
                                <tr class="text-sm text-gray-700 dark:text-gray-400 text-center">
