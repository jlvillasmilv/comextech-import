                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        <p class="font-semibold">{{ $address->id }}</p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <form action="{{ route('address.destroy', $address->id) }}" method="POST" onsubmit="return confirm('¿Esta Seguro?');" style="display: inline-block;">
