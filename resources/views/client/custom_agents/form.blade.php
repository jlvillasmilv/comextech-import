	...
	<div class="container grid px-6 mx-auto">
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
			...
			<div class="px-2">
				<div class="sm:flex mb-4">
					...
					<div class="w-auto sm:w-1/2 sm:ml-1">
                        ...
                        <label class="block text-sm my-3">
                            <span class="text-gray-700 dark:text-gray-400">Nombre agencia de aduana</span>
				...
				<div class="sm:flex mb-4">
					...
					<div class="w-auto sm:w-1/2 ml-1">
                        ...
                        <label class="block text-sm my-3">
                            ...
                            <input type="number" class="{{ $errors->has('rate') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Tarifa Base" name="rate" value="{{ old('name', isset($data) ? $data->rate : 0) }}"  required="">
                            @if($errors->has('rate'))
                                     <span class="text-xs text-red-600 dark:text-red-400">
                                        {{ $errors->first('rate') }}
                                    </span>
	       ...
	       <div class="flex justify-end">
		        <button class="flex  px-4 py-2 my-8 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-1300 border border-transparent rounded-lg hover:bg-blue-1400 focus:outline-none focus:shadow-outline-blue">
