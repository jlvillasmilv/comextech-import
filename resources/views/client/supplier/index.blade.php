<x-app-layout title="Import">
    ...
    <div class="container grid px-6 mx-auto">
        ...
        <div class="flex justify-between items-end">
            ...
            <a  href="{{route('supplier.create')}}" class="flex px-2 py-2 m-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-1300 border border-transparent rounded-lg active:bg-blue-1300 hover:bg-blue-1000 focus:outline-none focus:shadow-outline-blue">
                                    ...
                                    href="{{ route('supplier.show', $supplier->id) }}" 
                                        ...
                                        <a  href="{{ route('supplier.edit', $supplier->id) }}"
                                            ...
                                            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path
                                                    fill="#4db2dc" d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z">
                                                </path>
                                            </svg>
                                        </a>                                   
                                </div>
