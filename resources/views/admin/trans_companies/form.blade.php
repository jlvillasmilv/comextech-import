        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
			...
			<div class="mt-4 text-sm">
				<label class="block text-sm my-3">
					...
					<input class="{{ $errors->has('name') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Nombre" name="name" value="{{ old('name', isset($data) ? $data->name : '') }}" max="100" required="">
					@if($errors->has('name'))
			...
			<div class="mt-4 text-sm">
				<label class="block text-sm my-3">
					...
					<input class="{{ $errors->has('description') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="description" value="{{ old('description', isset($data) ? $data->description : '') }}" >
			...
			<div class="mt-4 text-sm">
				<label class="block text-sm my-3">
					...
					<input type="url" class="{{ $errors->has('url') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="url" value="{{ old('url', isset($data) ? $data->url : '') }}" >
					@if($errors->has('url'))
							<span class="text-xs text-red-600 dark:text-red-400">
								{{ $errors->first('url') }}
							</span>
