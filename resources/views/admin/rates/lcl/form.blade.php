<x-app-layout title="Formulario de registro">
	<div class="container grid px-6 mx-auto">
		<h2 class="mt-5   text-2xl font-semibold text-gray-700 dark:text-gray-200">
            <a href="{{route('admin.rates.lcl.index')}}">Tarifas LCL</a>  
        </h2>
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ isset($data) ? route('admin.rates.lcl.update', base64_encode($data->id)) : route('admin.rates.lcl.store') }}"  enctype="multipart/form-data">
                @csrf
                 @if(isset($data))
		           @method('PUT')
		        @endif
				...
				<div class="px-2" id="add_to">
					<div class="flex mb-4">
						<div class="w-auto mr-1 sm:w-full">
							...
							<input class="{{ $errors->has('MIN_0_5') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
							type="number"
							name="MIN_0_5"
						...
						<div class="w-auto ml-1 sm:w-full">
							...
							<input class="{{ $errors->has('w0_5_TON_M3') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
							type="number"
							name="w0_5_TON_M3"
							value="{{ old('w0_5_TON_M3', isset($data) ? $data->w0_5_TON_M3 : '') }}" 
							required="">
							
							@if($errors->has('w0_5_TON_M3'))
								<span class="text-xs text-red-600 dark:text-red-400">
									{{ $errors->first('w0_5_TON_M3') }}
								</span>
							@endif
						...
						<div class="w-auto ml-1 sm:w-full">
							...
							<input class="{{ $errors->has('MIN_5_10') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
							type="number"
							name="MIN_5_10"
							value="{{ old('MIN_5_10', isset($data) ? $data->MIN_5_10 : '') }}" 
							required="">
							
							@if($errors->has('MIN_5_10'))
								<span class="text-xs text-red-600 dark:text-red-400">
									{{ $errors->first('MIN_5_10') }}
								</span>
							@endif
				...
				<div class="px-2" id="add_to">
					<div class="flex mb-4">
						<div class="w-auto ml-1 sm:w-full">
							...
							<input class="{{ $errors->has('w5_10_TON_M3') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
							type="number"
							name="w5_10_TON_M3"
							value="{{ old('w5_10_TON_M3', isset($data) ? $data->w5_10_TON_M3 : '') }}" 
							required="">
							
							@if($errors->has('w5_10_TON_M3'))
								<span class="text-xs text-red-600 dark:text-red-400">
									{{ $errors->first('w5_10_TON_M3') }}
								</span>
							@endif
						...
						<div class="w-auto ml-1 sm:w-full">
							<label class="block text-grey-darker text-sm font-bold mb-2 dark:text-gray-300">MIN_10_5:</label>

							<input class="{{ $errors->has('MIN_10_5') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
							type="number"
							name="MIN_10_5"
							value="{{ old('MIN_10_5', isset($data) ? $data->MIN_10_5 : '') }}" 
							required="">
							
							@if($errors->has('MIN_10_5'))
								<span class="text-xs text-red-600 dark:text-red-400">
									{{ $errors->first('MIN_10_5') }}
								</span>
							@endif
						...
						<div class="w-auto ml-1 sm:w-full">
							<label class="block text-grey-darker text-sm font-bold mb-2 dark:text-gray-300">10_15_TON_M3:</label>

							<input class="{{ $errors->has('w10_15_TON_M3') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
							type="number"
							name="w10_15_TON_M3"
							value="{{ old('w10_15_TON_M3', isset($data) ? $data->w10_15_TON_M3 : '') }}" 
							required="">
							
							@if($errors->has('w10_15_TON_M3'))
								<span class="text-xs text-red-600 dark:text-red-400">
									{{ $errors->first('w10_15_TON_M3') }}
								</span>
							@endif
