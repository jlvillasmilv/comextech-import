				...
				<div class="flex mb-4">
					<div class="w-1/2 mr-1">
						<label class="block text-sm my-3">
							...
							<input class="{{ $errors->has('postal_code') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Breve descripción" / name="postal_code" value="{{ old('postal_code', isset($data) ? $data->postal_code : '') }}" max="10" >
					...
					<div class="w-1/2 ml-1">
						<label class="block text-sm my-3">
							...
							<input class="{{ $errors->has('phone_number') ? ' border-red-600 ' : '' }} block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Breve descripción" / name="phone_number" value="{{ old('phone_number', isset($data) ? $data->phone_number : '') }}" max="50">
