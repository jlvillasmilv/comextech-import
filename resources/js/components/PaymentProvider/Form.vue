        ...
        <div class="  mx-3 px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800    ">
            ...
            <div class="flex flex-wrap -mx-3  ">
                <div class="w-full md:w-1/2 px-3 md:mb-0">
                        <span class="text-gray-700 dark:text-gray-400 text-xs"> Porcentaje de Pago Nro 1</span>
                        <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input text-center" placeholder="%" />
                </div>
                <div class="w-full md:w-1/2 px-3 md:mb-0">
                        <span class="text-gray-700 dark:text-gray-400 text-xs"> Monto de Operacion </span>
                        <span class="block w-full mt-1 text-lg  text-center"  >70.000.000</span>
                </div>
            </div>
            <div class="flex flex-wrap -mx-3  ">
                <div class="w-full md:w-1/2 px-3">
                    <span class="text-gray-700 dark:text-gray-400 text-xs"> Fecha a Pagar Porcentaje</span>
                    <input type="date" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Empresa" />
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <span class="text-gray-700 dark:text-gray-400 text-xs"> Forma de Pago </span>
                        <div class="relative">
                            <select class="block appearance-none w-full border border-gray-150 dark:border-gray-600  text-gray-700 p-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
