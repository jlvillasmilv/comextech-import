          ...
          <div v-if="showShipping == true" class="flex justify-around w-full px-3 mb-6 md:mb-0">
            ...
            <label class="w-8/12 text-sm">
              ...
              <vue-google-autocomplete
                ...
                classname="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                :placeholder="
                  expenses.fav_dest_address ? 'Nombre o codigo Puerto/Aeropuerto' : 'Direccion'
                "
                v-on:placechanged="getAddressDestination"
              >
              </vue-google-autocomplete>
    ...
    <section v-if="lclTable">
      <div class="flex justify-between">
          ...
          <table>
            ...
            <tbody class="divide-y">
              ...
              <tr>
                ...
                <td class="px-4 py-1">105</td>
              </tr>
              <tr>
                <td class="px-4 py-1">MIN</td>
                <td class="px-4 py-1">120</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div class="mx-8">
          <table>
            ...
            <tbody class="divide-y">
              <tr>
                <td class="px-4 py-1">Largo (cm)</td>
                <td class="px-4 py-1">150</td>
              </tr>
              <tr>
                <td class="px-4 py-1">Alto (cm)</td>
                <td class="px-4 py-1">150</td>
              </tr>
              <tr>
                <td class="px-4 py-1">Ancho (cm)</td>
                <td class="px-4 py-1">150</td>
              </tr>
              <tr>
                <td class="px-4 py-1">M3,CBM =</td>
                <td class="px-4 py-1">3,375</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div>
        <table>
          ...
          <tbody class="divide-y">
            <tr>
              <td class="px-4 py-1">Peso (KG)</td>
              <td class="px-4 py-1">2.000</td>
            </tr>
            <tr>
              <td class="px-4 py-1">TON</td>
              <td class="px-4 py-1">2</td>
            </tr>
            <tr>
              <td class="px-4 py-1">CBM</td>
              <td class="px-4 py-1">2,38</td>
            </tr>
            <tr>
              <td class="px-4 py-1">TON/M3</td>
              <td class="px-4 py-1">3,38</td>
            </tr>
            <tr>
