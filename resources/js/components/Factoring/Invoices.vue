<template>
  <div
    v-if="isLoanding"
    :class="[
      'relative w-full flex flex-col justify-center text-center ',
      items.length === 0 ? 'h-60' : ''
    ]"
  >
          ...
          <div class="flex flex-wrap justify-between items-center my-3">
            ...
            <div class="flex flex-wrap justify-start">
              <span class="inline-block">
                ...
                >
                  <g fill="none">
                    <circle cx="11" cy="12" r="11" stroke="currentColor" stroke-width="2" />
                  </g>
                </svg>
              ...
              <span>
                ...
                >
                  <g fill="none">
                    <circle cx="11" cy="11" r="11" fill="#bfbcbb" />
                  </g>
                </svg>
              ...
              >
                <template slot="table-row" slot-scope="props">
                  ...
                  <span v-if="props.column.field == 'rut'">
                    {{ props.row.rut | VMask('##.###.###-NN') }}
                  </span>
                  <span v-else>
                    {{ props.formattedRow[props.column.field] }}
                  </span>
                  <span v-if="props.column.field == 'settlement'">
                    <span v-if="props.row.settlement_status_id == 1"
                      ><svg
                        class="inline-block"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <span v-if="props.row.settlement_status_id == 2">
                      <svg
                        class="inline-block"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <span v-if="props.row.settlement_status_id == 3">
                      <svg
                        class="inline-block"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
...
export default {
  ...
  methods: {
    ...
    async onRowSelected(item) {
      this.invoices = this.invoices.filter((items) => items.folio !== item.folio);
      this.$swal.fire(Option('success', ` Factura Cotizada! Folio ${item.folio}`));
      let data = {
        rut: item.rut,
        payer: item.name,
        number: item.folio,
    ...
    onDelete: function(index, item) {
      let result = this.invoicesOriginal.find((element) => element.folio == item.number);
